...
export default function ProjectsSection() {
  const projects = [
...

    {
      ...
      techStack: ["Nextjs", "Expess", "Python", "Solidity", "Ethereum"],
      liveDemo: "https://evault.nagarajneelam.me",
    ...
    },
    {
      id: 3,
      title: "Zentro",
      description: " Zentro is an AI-powered platform that acts as your personal financial strategist, automating cash flow analysis, budgeting, tax compliance, and strategic planning to drive smarter business and personal finance decisions effortlessly.",
      techStack: ["Nextjs", "Fastapi", "Langchain", "PostgreSQL", "LLM"],
      liveDemo: "https://zentroai.nagarajneelam.me",
      github: "https://github.com/neelamnagarajgithub/Zentro",
      category: "Agentic AI",
      accent: "peach"
    }
  ];
        ...
        <FadeIn>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[rgb(var(--color-text-secondary))] max-w-2xl mx-auto leading-relaxed">
              Showcasing innovative Software solutions that drive real-world impact through cutting-edge technology and thoughtful engineering.
            </p>
          </div>
        </FadeIn>
